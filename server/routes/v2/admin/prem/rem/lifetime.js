    ...
    if (!auth)
      ...
      if (!user)
        ...
        return reply.status(409).send({
          message:
            "Conflict Found: Provided User is not subscribed to our Lifetime Premium Program",
          error: true,
          fatal: false,
          status: 409,
        });
        ...
        await user.notifications.set(
          "Congratulations!",
          "One of our Website Admins have removed your Premium Subscription!"
        );
        ...
        return reply.status(200).send({
          message:
            "Okay, That user has been removed from our Lifetime Premium Program!",
          error: false,
          fatal: false,
          status: 200,
        });
