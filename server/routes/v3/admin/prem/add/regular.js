    ...
    if (!auth)
      ...
      if (!user)
        ...
        return reply.status(409).send({
          message:
            "Conflict Found: Provided User is already subscribed to our Premium Program",
          error: true,
          fatal: false,
          status: 409,
        });
        ...
        await user.notifications.set(
          "Congratulations!",
          "One of our Website Admins have provided you with Premium!"
        );
        ...
        return reply.status(200).send({
          message:
            "Okay, That user has been added to our Premium Program without a Lifetime Subscription",
          error: false,
          fatal: false,
          status: 200,
        });
